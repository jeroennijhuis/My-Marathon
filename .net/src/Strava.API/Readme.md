...
WORKDIR /src
COPY ["Strava.API.csproj", "Strava.API/"]
RUN dotnet restore "Strava.API/Strava.API.csproj"

WORKDIR "/src/Strava.API"
COPY . .
RUN dotnet build "Strava.API.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "Strava.API.csproj" \
